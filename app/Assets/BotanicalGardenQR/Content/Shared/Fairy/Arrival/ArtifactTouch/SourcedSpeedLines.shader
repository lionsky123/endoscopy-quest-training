// Adapted from Mirza Beig Anime-Speed-Lines (Unlicense). Original polar/noise/mask calculation retained. XR overlay avoids scene-color sampling.
// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "BotanicalGardenQR/Fairy/SourcedSpeedLines"
{
	Properties
	{
 ...
 uniform sampler2D _MainTex;
			...
			{
				v2f_img_custom o;
 UNITY_SETUP_INSTANCE_ID(v); UNITY_INITIALIZE_OUTPUT(v2f_img_custom,o); UNITY_INITIALIZE_VERTEX_OUTPUT_STEREO(o);
 ...
 return o;
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float2 appendResult58 = (float2(( -_SpeedLinesAnimation * _ArrivalTime ) , 0.0));
				...
				return float4(ColourRGB38, saturate(MaskedSpeedLines29 * ColourA40));
			} 
			ENDCG 
		}
	}
