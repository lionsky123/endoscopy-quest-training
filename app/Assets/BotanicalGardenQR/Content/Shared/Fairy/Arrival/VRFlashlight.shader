...
Shader "TheWorldBeyond/VRFlashlight"
{
    Properties
    {
        ...
        [Enum(UnityEngine.Rendering.CompareFunction)] _StencilComp("Window Stencil Comparison", Float) = 8
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            // The automatic window limits alpha coverage to its visible other-world stencil.
            // Always remains the default for the original flashlight material.
            Stencil
            {
                Ref 1
                ReadMask 255
